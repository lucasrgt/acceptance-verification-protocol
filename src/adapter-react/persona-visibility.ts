...
/** The React adapter's hooks for the `persona-scoped-visibility` archetype. */
export function personaHooks(subject: PersonaSubject): VerifyHooks {
  return { probe: () => personaProbe(subject) };
}
